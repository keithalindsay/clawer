...
export default function FinalCTA() {
  return (
    <section className="py-24 px-6 bg-gradient-to-br from-orange-50 via-amber-50 to-white">
      <div className="max-w-4xl mx-auto">
        <motion.div
          className="bg-white rounded-3xl p-12 md:p-16 shadow-xl shadow-gray-200/50 border border-gray-100 text-center"
        ...
        >
          ...
          {/* Trust Signals */}
          <motion.div
            className="mt-10 pt-8 border-t border-gray-100 flex flex-wrap justify-center items-center gap-6 text-sm text-gray-500"
            initial={{ opacity: 0 }}
