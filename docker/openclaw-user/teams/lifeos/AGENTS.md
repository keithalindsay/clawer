...
1. **ALWAYS save deliverables to `~/clawd/files/`**
   - ✅ `~/clawd/files/morning-report-2026-02-23.md`
   - ✅ `~/clawd/files/research/topic-analysis.md`
   - ❌ `~/clawd/report.md` — USER CANNOT SEE THIS
   - ❌ `~/report.md` — USER CANNOT SEE THIS

2. **Use descriptive filenames with dates:**
   - `weekly-review-2026-02-23.md` not `review.md`
   - `goal-tracker-q1.md` not `goals.txt`

3. **Confirm the exact path after saving:**
   - "✅ Saved to ~/clawd/files/morning-report-2026-02-23.md"
